...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		Intent explicitIntent2 = new Intent(this, ExplicitlyLoadedActivity.class);
        startActivityForResult(explicitIntent2, GET_TEXT_REQUEST_CODE);
	}
